...
export function timeForMat(count) {
  ...
  for (var i = 0; i < count; i++) {
    ...
    time1.setTime(time1.getTime() - (24 * 60 * 60 * 1000 * (count - i)))
...
export function onlySevenDays() {
  // 获取最近七天unix时间戳范围
  const timer = timeForMat(7)[1]
  const start = timer[0] + ' 00:00:00'
  const end = timer[6] + ' 23:59:59'
  return {
